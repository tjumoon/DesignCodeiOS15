...
var featuredCourses = [
    ...
    Course(title: "SwiftUI for iOS 15", subTitle: "20 sections - 3 hours", text: "Build an iOS app for iOS 15 with custom layouts, animations and ...", image: "Illustration 3", background: "Background 4", logo: "Logo 4"),
